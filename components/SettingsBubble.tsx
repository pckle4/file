...
export const SettingsBubble: React.FC<SettingsBubbleProps> = ({ 
  ...
  return (
    <div className={cn(
      ...
      {isOpen && (
        <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-neutral-700 rounded-2xl shadow-2xl p-4 w-72 mb-2 animate-slide-up origin-bottom-right">
