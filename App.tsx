    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#050505] text-slate-900 dark:text-slate-100 relative overflow-x-hidden selection:bg-violet-500/30 transition-colors duration-300">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 relative z-10 flex flex-col pb-32" style={{ overflowAnchor: 'none' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="relative overflow-hidden bg-white/80 dark:bg-[#0F0F0F]/90 backdrop-blur-sm border border-slate-200 dark:border-neutral-800 rounded-3xl p-6 shadow-xl shadow-slate-200/50 dark:shadow-black/20 hover:shadow-2xl transition-all duration-300 group">
             ...
             <div className="space-y-4">
               ...
               <div className="flex gap-2">
                 <div className="relative flex-1 group/input">
                    <Key className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5 group-focus-within/input:text-violet-500 transition-colors" />
                    <input
                      type="text"
                      maxLength={6}
